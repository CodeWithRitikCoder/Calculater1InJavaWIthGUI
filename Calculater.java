...
public class Calculater /*implements ActionListener*/{
	...
	public void setComponents(){
		...
		jFrame.setBounds(950, 100, 282, 390);//440h
		...
		jLabelForFirstNumber= new JLabel("");
		jLabelForFirstNumber.setBounds(160, 104, 100, 50);
		...
		jButtonForAddition.setBounds(205, 230, 50, 30);//280
		jButtonForAddition.setFont(font);
		
		jButtonForSubtraction= new JButton("-");
		jButtonForSubtraction.setBounds(205, 190, 50, 30);//240
		jButtonForSubtraction.setFont(font);
		
		jButtonForMultiplication= new JButton("x");
		jButtonForMultiplication.setBounds(205, 150, 50, 30);//200y
		jButtonForMultiplication.setFont(font);
		
		jButtonForDivision= new JButton("/");
		jButtonForDivision.setBounds(140, 150, 50, 30);//200y
		jButtonForDivision.setFont(font);
		
		jButtonForModulus= new JButton("%");
		jButtonForModulus.setBounds(75, 150, 50, 30);//200y
		jButtonForModulus.setFont(new Font("Normal", Font.BOLD, 15));
		
		jB9= new JButton("9");
		jB9.setBounds(10, 190, 50, 30);//240y
		
		jB8= new JButton("8");
		jB8.setBounds(75, 190, 50, 30);//240y
		
		jB7= new JButton("7");
		jB7.setBounds(140, 190, 50, 30);//240y
		
		jB6= new JButton("6");
		jB6.setBounds(10, 230, 50, 30);//280y
		
		jB5= new JButton("5");
		jB5.setBounds(75, 230, 50, 30);//280y
		
		jB4= new JButton("4");
		jB4.setBounds(140, 230, 50, 30);//280y
		
		jB3= new JButton("3");
		jB3.setBounds(10, 270, 50, 30);//320y
		
		jB2= new JButton("2");
		jB2.setBounds(75, 270, 50, 30);//320y
		
		jB1= new JButton("1");
		jB1.setBounds(140, 270, 50, 30);//320y
		
		jB0= new JButton("0");
		jB0.setBounds(10, 310, 50, 30);//360y
		
		jB00= new JButton("00");
		jB00.setBounds(75, 310, 50, 30);//360y
		
		jBPoint= new JButton(".");
		jBPoint.setBounds(140, 310, 50, 30);//360y
		
		jBEqual= new JButton("=");
		jBEqual.setBounds(205, 270, 50, 30);//320y
		jBEqual.setFont(font);
		
		jBClear= new JButton("CL");
		jBClear.setBounds(10, 150, 50, 30);//200y
		
		jBDelete= new JButton("<x");
		jBDelete.setBounds(205, 310, 50, 30);//360y
		
		jBExpend= new JButton("---");
		jBExpend.setBounds(18, 130, 30, 10);//115x
		...
		public void actionPerformed(ActionEvent e){
			if(e.getSource()== jButtonForAddition){
				if(jTextFieldForFirstNumber.getText().trim().isEmpty()/* || jTextFieldForSecondNumber.getText().trim().isEmpty()*/){
					...
					operator= '+';
					jLabelForFirstNumber.setText(String.valueOf(a));
				...
				if(jTextFieldForFirstNumber.getText().trim().isEmpty() /*|| jTextFieldForSecondNumber.getText().trim().isEmpty()*/){
					...
					switch(operator){
						...
						case '%':
							...
							break;
						default:
							JOptionPane.showMessageDialog(null, "Select your operation first");
							break;
					}
				...
				if(jTextFieldForFirstNumber.getText().trim().isEmpty() && jLabelForFirstNumber.getText().trim().isEmpty()){
					JOptionPane.showMessageDialog(null, "Fields are already empty");
				}else{
					jTextFieldForFirstNumber.setText("");
					jTextFieldForSecondNumber.setText("");
					jLabelForFirstNumber.setText("");
				}
				...
				/*if(booleanForExpend){
					expendedMethod();
					booleanForExpend= false;
				}else if (!booleanForExpend){
					diExpendedMethod();
					booleanForExpend= true;
				}*/
				Calculater1 calculater1= new Calculater1();
